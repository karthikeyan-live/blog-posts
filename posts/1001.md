...
The setup is done, now go to the Actions tab of the GitHub Repository (blog-template) you could see the CI failed alrea
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTc0Mzg0MTU0NSwyMDEzNDgwOTMzLC0yMT
