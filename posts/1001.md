...
## Firebase
Now, we are going to host the React application in `blog-template` repository to the firebase. This is very simple, as 
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTA1OTEyMDgzNywyMDEzNDgwOTMzLC0yMT
