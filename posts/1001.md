...
Create a folder `posts` in the root of the repository `blog-posts`, under this folder create a md file for your post the file name will be the id of your blog post, creating a file name 1001 can be browsed using 
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTgzOTkzMzMxMywxOTIwMTM4NjI2LC05NT
QxNDA2NjYsLTIwMjc4OTgyOTYsMTAxNjU1NTU5OSwtMTc4Mjgx
OTQ1OCwtODUzMDM4MDc1XX0=
-->